...
def args_parser():
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='cifar-100', help="name of dataset")
    ...
    parser.add_argument(
        ...
        default=1,
        type=float,
        help='sparsification ratio from client to edge'
    )
    ...
    parser.add_argument(
        ...
        default=32,
        type=float,
        help='quantization ratio from edge to edge'
    )
    parser.add_argument(
        '--comm_scheme',
        default='SGD'
